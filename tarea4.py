import logging  # biblioteca logging
from abc import ABC, abstractmethod  # clase base abstracta ABC / abstractmethod método obligatorio
#=========================================================================
#Un archivo de logs donde se registren todos los errores y eventos relevantes

logging.basicConfig( # Configura el sistema de logs: # - Guarda en 'errores' 
    filename='errores',# - Registra mensajes desde nivel INFO en adelante 
    level=logging.INFO,# - Muestra: fecha/hora - nivel (INFO, ERROR...) - mensaje 
    format='%(asctime)s - %(levelname)s - %(message)s')
#===========================================================================


# bloque de clases
class SistemaError(Exception):  # hereda de Exception
    pass

class ValidacionError(SistemaError):# heresa de sistemaerror ambas clases
    pass
